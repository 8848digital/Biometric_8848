            ...
            for record in records:
                if record.strip():
                    ...
                    if len(fields) >= 2:
                        ...
                        if settings.employee_checkin == 1 or settings.attendance == 1 or settings.attendance_request == 1:
                            ...
                            if emp_id:
                                ...
                                attendance = frappe.get_doc({
                                    "doctype": "Attendance",
                                    "employee": emp_id,
                                    "attendance_date": employee_time,  # Use employee_time here, not self.employee_time
                                    "status": "Present"
                                })
                                ...
                                attendance_request = frappe.get_doc({
                                    ...
                                    "employee": emp_id,
                                    "from_date": employee_time,
                                    "to_date": employee_time,
                                    "reason": "On Duty",
                                    "status": "Open",
                                })
